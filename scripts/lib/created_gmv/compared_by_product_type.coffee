Model = require './gmv_all_by_product_type'
ComparedGrouped = require '../shared/compared_grouped'
ComparedTransactions = require '../created_transactions/compared_by_product_type'
...
class ComparedByProductType extends ComparedGrouped
  ...
  toString: (currentPrefix, otherPrefix) ->
    super('product type', "#{currentPrefix} Created GMV", "#{otherPrefix} Created GMV")
