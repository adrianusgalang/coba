Model = require './gmv_all_by_payment_method'
ComparedGrouped = require '../shared/compared_grouped'
ComparedTransactions = require '../created_transactions/compared_by_payment_method'
...
class ComparedByPaymentMethod extends ComparedGrouped
  ...
  toString: (currentPrefix, otherPrefix) ->
    super('payment method', "#{currentPrefix} Created GMV", "#{otherPrefix} Created GMV")
