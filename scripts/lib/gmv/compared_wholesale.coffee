Model = require './gmv_all_wholesale'
ComparedSimple = require '../shared/compared_simple'
ComparedTransactions = require '../paid_transactions/compared_wholesale'
...
class Compared extends ComparedSimple
  ...
  toString: (currentPrefix, otherPrefix) ->
    super("#{currentPrefix} GMV wholesale", "#{otherPrefix} GMV wholesale")
