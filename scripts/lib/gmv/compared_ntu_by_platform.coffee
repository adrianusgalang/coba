Model = require './gmv_all_ntu_by_platform'
ComparedGrouped = require '../shared/compared_grouped'
ComparedTransactions = require '../paid_transactions/compared_ntu_by_platform'
...
class ComparedByPlatform extends ComparedGrouped
  ...
  toString: (currentPrefix, otherPrefix) ->
    super('platform', "#{currentPrefix} GMV without topup", "#{otherPrefix} GMV without topup")
