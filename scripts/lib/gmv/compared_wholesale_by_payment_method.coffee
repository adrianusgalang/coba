Model = require './gmv_all_wholesale_by_payment_method'
ComparedGrouped = require '../shared/compared_grouped'
ComparedTransactions = require '../paid_transactions/compared_wholesale_by_payment_method'
...
class ComparedByPaymentMethod extends ComparedGrouped
  ...
  toString: (currentPrefix, otherPrefix) ->
    super('payment method', "#{currentPrefix} GMV wholesale", "#{otherPrefix} GMV wholesale")
