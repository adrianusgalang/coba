Model = require './gmv_all_wholesale_by_platform'
ComparedGrouped = require '../shared/compared_grouped'
ComparedTransactions = require '../paid_transactions/compared_wholesale_by_platform'
...
class ComparedByPlatform extends ComparedGrouped
  ...
  toString: (currentPrefix, otherPrefix) ->
    super('platform', "#{currentPrefix} GMV wholesale", "#{otherPrefix} GMV wholesale")
